...
public class CommonUtil {
    ...
    // 微信参数配置
//    public static String API_KEY = WeChatConfig.APP_KEY;
    ...
    public static String createSign(String apiKey, String characterEncoding,
        ...
        String sign = WeChatMD5Utils.MD5Encode(sb.toString(), characterEncoding)
                .toUpperCase();
        return sign;
    }
     ...
     * @return
     */
    public static boolean isTenpaySign(String apiKey, Map<String, String> map) throws UnsupportedEncodingException {
        ...
        if (null == charset || "".equals(charset)) {
            resultSign = WeChatMD5Utils.MD5Encode(tobesign, charset)
                    .toUpperCase();
        } else {
            resultSign = WeChatMD5Utils.MD5Encode(tobesign, charset)
                    .toUpperCase();
...
//    public static String getSendParam(String orderId,BigDecimal totalFee,String NOTIFY_URL) {
...
//        parameters.put("body", "美浮特产品微信支付");//描叙
//        parameters.put("out_trade_no", orderId);//商户订单号
//        parameters.put("total_fee", totalFee.multiply(BigDecimal.valueOf(100)).intValue()); //单位（分）
//        parameters.put("spbill_create_ip", getLocalIP());//终端IP
//        parameters.put("notify_url", NOTIFY_URL);
//        parameters.put("trade_type", "APP");
//        String sign = createSign("UTF-8", parameters);
//        parameters.put("sign", sign); // 把签名后的数据组装成参数
//        String toSend = getRequestXml(parameters);
//        return toSend;
//    }
