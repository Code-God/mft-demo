...
public class RedisUtil {
    ...
    public static void delKeys(Set<String> keys) {
    ...
    public static String rPop(String key) {
        try {
            String value = (String)staticRedisTemplate.opsForList().rightPop(key);
            return value;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
    ...
    public static String lPop(String key) {
        try {
            String value = (String)staticRedisTemplate.opsForList().leftPop(key);
            return value;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
